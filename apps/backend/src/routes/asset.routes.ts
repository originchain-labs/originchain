...
import { prepare, finalize, confirm, devRegister, getCertificate, list, getOne, verify } from "../controllers/asset.controller.js";
...
router.post("/dev-register", requireAuth, devRegister);
