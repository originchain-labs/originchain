...
import { Award, Plus, Equal, ShieldCheck, Star, Activity, Sparkles, TrendingUp } from "lucide-react";
    ...
    return (
        <section className="relative min-h-screen py-24 flex flex-col justify-center overflow-hidden bg-transparent z-10 border-t border-white/5">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-7 gap-4 items-center max-w-5xl mx-auto">
                    {/* Item 1: Registered Assets */}
                    <motion.div
                        initial={{ opacity: 0, scale: 0.9 }}
                        whileInView={{ opacity: 1, scale: 1 }}
                        viewport={{ once: true }}
                        className="lg:col-span-2 p-6 rounded-2xl bg-slate-900/60 border border-cyan-500/30 text-center space-y-3 backdrop-blur-md shadow-xl"
                    >
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        transition={{ delay: 0.1 }}
                        className="lg:col-span-2 p-6 rounded-2xl bg-slate-900/60 border border-violet-500/30 text-center space-y-3 backdrop-blur-md shadow-xl"
                    >
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        transition={{ delay: 0.2 }}
                        className="lg:col-span-2 p-6 rounded-2xl bg-slate-900/60 border border-emerald-500/30 text-center space-y-3 backdrop-blur-md shadow-xl"
                    >
                ...
                {/* Equals Sign & Final Reputation Badge */}
